...
export default function NewItemForm({ id }: NewItemFormProps) {
    ...
    const fetchCategories = async () => {
        try {
            const response = await fetch(`/api/menus/${id}/categories`);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            router.push(`/dashboard/menus/${id}/items`);
            router.refresh();
        } catch (error) {
        ...
        <div className="max-w-2xl mx-auto p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 bg-white rounded-lg shadow-sm p-6">
                ...
                <div className="flex space-x-4 pt-4">
                    ...
                    <button
                        type="button"
                        onClick={() => router.push(`/dashboard/menus/${id}/items`)}
